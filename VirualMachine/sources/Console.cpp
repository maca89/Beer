...
void ConsoleClassInitializer::initClass(Thread* thread, ClassLoader* loader, Class* klass)
{
	...
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("Console"), BEER_WIDEN("Console::Console()"),			&Console::init, 1, 0);

	loader->addVirtualMethod(thread, klass, BEER_WIDEN("println"), BEER_WIDEN("Console::println()"),			&Console::println, 0, 0);

	loader->addVirtualMethod(thread, klass, BEER_WIDEN("print"),	BEER_WIDEN("Console::print(Integer)"),		&Console::printInteger,		0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("println"), BEER_WIDEN("Console::println(Integer)"),		&Console::printlnInteger,	0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("print"),	BEER_WIDEN("Console::print(Float)"),		&Console::printFloat,		0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("println"), BEER_WIDEN("Console::println(Float)"),		&Console::printlnFloat,		0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("print"),	BEER_WIDEN("Console::print(String)"),		&Console::printString,		0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("println"), BEER_WIDEN("Console::println(String)"),		&Console::printlnString,	0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("print"),	BEER_WIDEN("Console::print(Boolean)"),		&Console::printBoolean,		0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("println"), BEER_WIDEN("Console::println(Boolean)"),		&Console::printlnBoolean,	0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("print"),	BEER_WIDEN("Console::print(Array)"),		&Console::printArray,		0, 1);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("println"), BEER_WIDEN("Console::println(Array)"),		&Console::printlnArray,		0, 1);

	loader->addVirtualMethod(thread, klass, BEER_WIDEN("readInteger"), BEER_WIDEN("Console::readInteger()"),	&Console::readInteger,	1, 0);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("readFloat"),	BEER_WIDEN("Console::readFloat()"),		&Console::readFloat,	1, 0);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("readBoolean"), BEER_WIDEN("Console::readBoolean()"),	&Console::readBoolean,	1, 0);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("readLine"),	BEER_WIDEN("Console::readLine()"),			&Console::readLine,		1, 0);
	loader->addVirtualMethod(thread, klass, BEER_WIDEN("readFailed"),	BEER_WIDEN("Console::readFailed()"),	&Console::readFailed,	1, 0);

	loader->addVirtualMethod(thread, klass, BEER_WIDEN("getArg"), BEER_WIDEN("Console::getArg(Integer)"),		&Console::getArg, 1, 1);
}